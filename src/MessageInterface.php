...
interface MessageInterface
{
     ...
     *
     * @return array|string the sender
     */
     ...
     *
     * @param array|string $from sender email address.
     ...
     *
     * @return array|string the message recipients
     */
     ...
     *
     * @param array|string $cc copy receiver email address.
     * You may pass an array of addresses if multiple recipients should receive this message.
     * You may also specify receiver name in addition to email address using format:
     * `[email => name]`.
     *
     ...
     *
     * @param array|string $bcc hidden copy receiver email address.
     * You may pass an array of addresses if multiple recipients should receive this message.
     * You may also specify receiver name in addition to email address using format:
     * `[email => name]`.
     *
     ...
     *
     * @param string $name header name.
     * @param array|string $value header value or values.
     *
     * @return $this self reference.
     */
